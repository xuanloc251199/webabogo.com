<div class="customer-tax-information-form">
    ...
    >
        <div @class([
            ...
            <div class="form-input-wrappe r">
                <label for='tax-information-company-name'>{{ __('Company name') }}<span class="text-danger">*</span></label>
                <input
                ...
                >
                @error("tax_information.company_name")) <span class="text-danger">{{$message}}</span>@enderror
            </div>
{{--            {!! Form::error('tax_information.company_name', $errors) !!}--}}
        ...
        <div @class([
            ...
            <div class="form-input-wrapper">
                <label for='tax-information-company-address'>{{ __('Company address') }}<span class="text-danger">*</span></label>
                <input
                        class="form-control"
                ...
                @error("tax_information.company_address")) <span class="text-danger">{{$message}}</span>@enderror
            </div>
{{--            {!! Form::error('tax_information.company_address', $errors) !!}--}}
        ...
        <div @class([
            ...
            <div class="form-input-wrapper">
                <label for='tax-information-company-tax-code'>{{ __('Company tax code') }}<span class="text-danger">*</span></label>
                <input
                        class="form-control"
                ...
                >
                @error("tax_information.company_tax_code")) <span class="text-danger">{{$message}}</span>@enderror
            </div>
{{--            {!! Form::error('tax_information.company_tax_code', $errors) !!}--}}
        ...
        <div @class([
            ...
            <div class="form-input-wrapper">
                <label for='tax-information-company-email'>{{ __('Company email') }}<span class="text-danger">*</span></label>
                <input
                        class="form-control"
                ...
                >
                @error("tax_information.company_email")) <span class="text-danger">{{$message}}</span>@enderror
            </div>
