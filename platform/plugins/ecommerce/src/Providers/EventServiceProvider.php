...
use Botble\Ecommerce\Events\fronts\ChangePasswordEvent;
...
use Botble\Ecommerce\Listeners\fronts\ChangePasswordListen;
use Botble\Ecommerce\Listeners\fronts\OrderCanceledListen;
use Botble\Ecommerce\Listeners\fronts\OrderCompletedListen;
use Botble\Ecommerce\Listeners\fronts\OrderConfirmedListen;
use Botble\Ecommerce\Listeners\fronts\PaymentSuccessedListen;
use Botble\Ecommerce\Listeners\fronts\PromotionCreateListen;
...
{
    protected $listen = [
        PromotionCreateEvent::class => [
            PromotionCreateListen::class,
        ],
        ChangePasswordEvent::class => [
            ChangePasswordListen::class,
        ],
        OrderCanceledEvent::class => [
            OrderCanceledListen::class,
        ],
        \Botble\Ecommerce\Events\fronts\OrderCompletedEvent::class => [
            OrderCompletedListen::class,
        ],
        OrderConfirmedEvent::class => [
            OrderConfirmedListen::class,
        ],
        PaymentSuccessedEvent::class => [
            PaymentSuccessedListen::class,
        ],
