...
<style>
    ...
    .policies .content.active_policies {
        height: auto;
        overflow: unset;
    }
    .read-more{
...
<div class="product-service-detail container">
    ...
    <div class="row pb-3 pb-md-0">
        ...
        <div class="col-12 col-md-4  pb-md-5">
            <div class="product-total d-flex flex-column bg-white rounded-20 p-4 mt-3 h-100">
                <div class="row mb-3">
                ...
                <div class="d-flex justify-content-between my-1">
                    ...
                    <div
                        class="fs-16 fw-500">{{$adults_number}}</div>
                </div>
                <div class="d-flex justify-content-between my-1">
                    <div class="fs-16 fw-500">Trẻ em</div>
                    <div
                        class="fs-16 fw-500">{{$children_number}}</div>
                </div>
                ...
                <div class="d-flex justify-content-center mt-3">
                    @if(isset($_GET["rowId"]))
                        <form
                            action="{{ route('public.cart.reschedule',['product_id' => $product->id,"rowId" => $_GET["rowId"]]) }}"
                            method="post">
                            @csrf
...
<script>
    const ajaxCalendarPriceRoute = "{{ route('public.ajax.product-price-calendar',['product_id' => $product->id]) }}"
</script>
