...
class Post extends BaseModel
{
    ...
    protected static function booted(): void
    {
        static::deleted(function (Post $post) {
            ...
            $post->tags()->detach();
            $post->product_categories()->detach();
        });
    }
    ...
    {
        return $this->belongsToMany(ProductCategory::class, 'ec_product_categories_posts', "post_id", "product_category_id");
    }
//    public function places(): BelongsToMany
//    {
//        return $this->belongsToMany(Place::class, 'post_place', "post_id", "place_id");
//    }
