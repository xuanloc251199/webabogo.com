...
use Theme\Abogo\Http\Controllers\GoogleController;
...
//        Route::get('/auth/google', [GoogleController::class, 'redirectToGoogle'])->name("login.with.gg");
    ...
    Route::middleware('customer')
        ...
        ->group(function () {
            ...
            Route::prefix('customer')->group(function () {
                ...
                Route::post('update-social-media', [
                    'as' => 'update-social-media',
                    'uses' => 'PublicController@postUpdateSocialMedia',
                ]);
