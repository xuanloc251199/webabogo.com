...
//                    ->whereHas('posts')
                    ...
                    ->orderByDesc('created_at')
                    ->get(),
                'recentBlogs' => get_recent_posts((int) theme_option('number_of_posts_in_a_category', 12)),
                'featuredBlogs' => get_featured_posts((int) theme_option('number_of_posts_in_a_category', 12),['slugable', 'categories']),
                'places' => Place::whereHas('posts')->get(),
            ])->render();
        }
