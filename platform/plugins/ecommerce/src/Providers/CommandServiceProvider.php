...
use Botble\Ecommerce\Commands\PublishAssetsCommand;
use Botble\Ecommerce\Commands\RemovePrefixRouteProductCategoryCommand;
...
class CommandServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        $this->commands([
            ...
            RemovePrefixRouteProductCategoryCommand::class,
