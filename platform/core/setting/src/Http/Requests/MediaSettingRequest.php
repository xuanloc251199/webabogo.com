...
class MediaSettingRequest extends Request
{
    ...
    {
        $rules = [
            'media_driver' => ['required', 'string', 'in:public,s3,r2,do_spaces,wasabi,bunnycdn,ftp'],
            ...
            'media_ftp_host' => ['nullable', 'string', 'required_if:media_driver,ftp'],
            'media_ftp_username' => ['nullable', 'string', 'required_if:media_driver,ftp'],
            'media_ftp_password' => ['nullable', 'string', 'required_if:media_driver,ftp'],
            'media_ftp_root' => ['nullable', 'string', 'required_if:media_driver,ftp'],
            'media_ftp_custom_domain' => ['nullable', 'string', 'required_if:media_driver,ftp'],
