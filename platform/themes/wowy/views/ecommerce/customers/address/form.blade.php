<div class="card">
    ...
    <div class="card-body">
        {!! Form::open(['route' => $route]) !!}
            <div class="mb-3">
                <label class="form-label" for="name" class="required">{{ __('Full Name') }}:</label>
                <input id="name"
                    type="text"
            ...
            <div class="mb-3">
                <label class="form-label" for="phone" class="required">{{ __('Phone') }}:</label>
                <input id="phone"
                    type="text"
                    class="form-control square"
                    name="phone"
            ...
            @if (EcommerceHelper::isUsingInMultipleCountries())
                <div class="form-group @if ($errors->has('country')) has-error @endif">
                    <label class="form-label" for="country" class="required">{{ __('Country') }}:</label>
            ...
            <div class="form-group @if ($errors->has('state')) has-error @endif">
                <label class="form-label" for="state" class="required">{{ __('State') }}:</label>
            ...
            <div class="form-group @if ($errors->has('city')) has-error @endif">
                <label class="form-label" for="city" class="required">{{ __('City') }}:</label>
                @if (EcommerceHelper::loadCountriesStatesCitiesFromPluginLocation())
            ...
            <div class="mb-3">
                <label class="form-label" for="address" class="required">{{ __('Address') }}:</label>
                <input id="address"
                    type="text"
                    class="form-control square"
                    name="address"
            ...
            @if (EcommerceHelper::isZipCodeEnabled())
                <div class="mb-3">
                    <label class="form-label" for="zip_code" class="required">{{ __('Zip code') }}:</label>
                    <input id="zip_code"
                        type="text"
                        class="form-control"
                        name="zip_code"
            ...
            <div class="mb-3">
                <div class="custome-checkbox">
                    <input class="form-check-input"
                        ...
                        value="1"
                        id="is_default">
                    <label class="form-label" for="is_default" class="form-check-label">
