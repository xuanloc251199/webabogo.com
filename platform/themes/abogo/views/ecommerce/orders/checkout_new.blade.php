                                        ...
                                        <div class="row align-items-start">
                                            ...
                                            <div class="col-md-2 col-12">
                                                <div class="checkout-product-img-wrapper position-relative">
                                                    ...
                                                    <span
                                                        class="checkout-quantity position-absolute top-0 end-0 bg-primary text-white rounded-circle d-flex align-items-center justify-content-center"
                                            ...
                                            <div class="col-md-10 col-12 pt-3 pt-md-0">
                                                <div class="checkout-item-details">
                                                    ...
                                                    <div class="basic-info">
                                                        @if(!empty($days) && is_array($days) && count($days) > 0)
                                                            ...
                                                            <small class="text-black d-block">
                                                                Ngày {{ $startDate }}/{{ $monthStart }} -
                                                                Ngày {{ $endDate }}/{{$monthEnd}}
                                                            </small>
                                                        @endif
                                                        ...
                                                        <div class="guests-info mt-1">
                                                            <small class="text-muted">
                                                                ...
                                                                Người lớn: <span
                                                                    class="fw-medium">{{ $adultsNumber }}</span>
                                                                @if($childrenNumber > 0)
                                                                    | Trẻ em: <span
                                                    ...
                                                    @if(!empty($services) && is_array($services))
                                                        ...
                                                        <div class="collapse show services-info mt-2"
                                                             id="checkout-services-{{ $key }}">
                                                            <div class="">
                                                                @foreach($services as $service)
                                                                    @if(is_array($service) && ($service['quantity'] ?? 0) > 0)
                                                                        <div
                                                                            class="service-item d-flex justify-content-between align-items-center py-1">
                                                    ...
                                                    <div class="price-info pt-3">
                                                        ...
                                                        <div
                                                            ...
                                                            <small class="text-muted">Giá phòng ({{ $item->qty }}
                                                                ngày):</small>
                                                            <small
                                                                class="fw-medium">{{ format_price($item->qty * $item->price) }}</small>
                                                        </div>
                                                        ...
                                                        @if($childrenSurplus > 0)
                                                            <div
                                                                class="d-flex justify-content-between align-items-center mb-2">
                                                                <small class="text-muted">Phụ thu ({{$childrenSurplus}}
                                                                    trẻ em):</small>
                                                                <small
                                                                    class="fw-medium">{{ format_price($priceChildrenSurplus) }}</small>
                                                            </div>
                                                        @endif
                                                        ...
                                                        @if($addOn > 0)
                                                            <div
                                                                ...
                                                                <small
                                                                    class="fw-medium">{{ format_price($addOn) }}</small>
                                                            </div>
                                                        @endif
                                                        ...
                                                        @if($priceServiceOther > 0)
                                                            <div
                                                                ...
                                                                <span
                                                                    class="fw-bold text-primary">{{ format_price($priceServiceOther) }}</span>
                                                            </div>
                                                        @endif
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            <span
                                                                class="fw-bold text-success fs-5">{{ format_price($totalPrice) }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center p-3 border-bottom">
                                    <span class="text-muted">
                                        ...
                                        @if (Cart::instance('cart')->rawTax())
                                            <small
                                                class="text-muted">({{ Cart::instance('cart')->taxClassesName() }})</small>
                                        @endif
                                    </span>
                    ...
                    <div class="form-checkout">
                        ...
                        <div class="card bg-white rounded-3 mb-4 shadow-sm border p-4">
                            @if ($isShowAddressForm)
                                ...
                                <div>
                                    <h5 class="checkout-payment-title fw-bold mb-0 mb-3">Thông tin cá nhân</h5>
                                    <div class="customer-address-payment-form">
                                        ...
                                        <div class="address-form-wrapper ">
                                            ...
                                            <div class="form-group mb-4 ">
                                                <label class="form-label fw-medium mb-2" for="name">
                                                    Họ & Tên <span class="text-danger">*</span>
                                                </label>
                                                <input class="form-control form-control-lg" id="name"
                                                       name="address[name]" type="text"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group mb-4 ">
                                                        <label class="form-label fw-medium mb-2" for="phone">
                                                        ...
                                                        <div class="phone-input-group">
                                                            <div class="input-group">
                                                                ...
                                                                <input
                                                                    ...
                                                                    id="phone" name="address[phone]"
                                                                    autocomplete="phone" type="tel"
                                                                    value="{{old('phone',auth('customer')->user()->phone)}}"
                                                                    placeholder="Ví dụ: 096 969 3791" required="">
                                                            </div>
                                                        </div>
                                                        @error("address.phone")
                                                        <span class="text-danger">{{ $message }}</span>
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group mb-4 ">
                                                        <label class="form-label fw-medium mb-2" for="email">
                                                            Email
                                                        </label>
                                                        <input class="form-control form-control-lg" id="email"
                                                               name="address[email]" autocomplete="email" type="email"
                        ...
                        <div class="card bg-white rounded-3 mb-4 shadow-sm border mt-4 p-4">
                                ...
                                <div class="invoice-info-text">
                                    <div class="d-flex align-items-start gap-2 mb-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                             viewBox="0 0 14 14" fill="none" class="mt-1">
                                            <g clip-path="url(#clip0_3002_1325)">
                                                <path
                                                    d="M10.5333 1.96016C10.9066 1.58683 10.9066 0.986829 10.5333 0.613496C10.1599 0.240163 9.55994 0.240163 9.1866 0.613496L5.09994 4.70016L3.39327 2.9935C3.01994 2.62016 2.41993 2.62016 2.0466 2.9935C1.67327 3.36683 1.67327 3.96683 2.0466 4.34016L4.4266 6.72016C4.79994 7.0935 5.39993 7.0935 5.77327 6.72016L10.5333 1.96016Z"
                                                    fill="white"/>
                                                <path
                                                    d="M13.3865 5.7668C13.7598 5.39347 13.7598 4.79347 13.3865 4.42014C13.0132 4.0468 12.4132 4.0468 12.0398 4.42014L5.09984 11.3668L1.96651 8.23347C1.59318 7.86014 0.993177 7.86014 0.619844 8.23347C0.24651 8.6068 0.24651 9.2068 0.619844 9.58014L4.42651 13.3868C4.79984 13.7601 5.39984 13.7601 5.77318 13.3868L13.3932 5.7668H13.3865Z"
                                                    fill="white"/>
                                            </g>
                                            <defs>
                                                <clipPath id="clip0_3002_1325">
                                                    <rect width="13.3333" height="13.3333" fill="white"
                                                          transform="translate(0.333008 0.333496)"/>
                                                </clipPath>
                                            </defs>
                                        </svg>
                            ...
                            <div class="mt-3">Khi cần xuất hoá đơn GTGT, Quý khách vui lòng gửi yêu cầu đến Abogo kể từ
                                thời điểm nhận mail đến trước 15h00 ngày hôm sau
                            </div>
                            ...
                            {{--                                        value="1"--}}
                            {{--                                        @if (old('with_tax_information')) checked @endif--}}
                            {{--                                    >--}}
                            {{--                                    <label class="form-check-label fw-medium" for="with_tax_information">--}}
                            {{--                                        Tôi muốn xuất hoá đơn--}}
                            {{--                                    </label>--}}
                            {{--                                </div>--}}
                            {{--                            </div>--}}

                            {{--                            @error("with_tax_information")--}}
                            {{--                            <span class="text-danger">{{ $message }}</span>--}}
                            {{--                            @enderror--}}
                        </div>
                        ...
                        <div class="card bg-white rounded-3 mb-4 shadow-sm border mt-4 p-4">
                            <div @class([
                                ...
                                <h5 class="checkout-payment-title fw-bold mb-0 mb-3"
                                    for="description">{{ __('Order notes') }}</h5>
                                <textarea
                                    class="form-control"
                                    id="description"
                                    name="description"
