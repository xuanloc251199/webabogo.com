            ...
            {!! Form::open(['route' => 'customer.edit-account']) !!}
                <div class="row">
                    ...
                    <div class="form-group col-md-12 @if ($errors->has('dob')) has-error @endif">
                        ...
                        <input id="date_of_birth" type="text" class="form-control square" name="dob" placeholder="Y-m-d" value="{{ auth('customer')->user()->dob ? auth('customer')->user()->dob->toDateString() : null }}">
                        {!! Form::error('name', $errors) !!}
                    </div>
