    ...
    public static function convertSocialLinksToArray(array $data): array
    {
        ...
        foreach ($data as $item) {
            ...
            $socialLinks[] = new SocialLink(
                ...
                color: Arr::get($item, 'color') ?: Arr::get($item, 'social-color'),
                backgroundColor: Arr::get($item, 'background-color') ?: Arr::get($item, 'social-background-color')
            );
        }
