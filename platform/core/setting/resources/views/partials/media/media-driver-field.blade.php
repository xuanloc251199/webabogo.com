<x-core-setting::form-group>
    ...
    <x-core::form.fieldset
        data-bb-value="ftp"
        class="media-driver"
        @style(['display: none;' => old('media_driver', RvMedia::getMediaDriver()) !== 'ftp'])
    >
        <x-core::form.text-input
            name="media_ftp_host"
            :label="trans('FTP Host')"
            :value="setting('media_ftp_host')"
            placeholder="Ex: 199.199.99.999"
        />

        <x-core::form.text-input
            name="media_ftp_username"
            :label="trans('FTP username')"
            :value="setting('media_ftp_username')"
            placeholder="Ex: ftp_username"
        />

        <x-core::form.text-input
            name="media_ftp_password"
            type="password"
            :label="trans('FTP Password')"
            :value="setting('media_ftp_password')"
            placeholder="Ex: 9a734df7-844b-..."
        />

        <x-core::form.text-input
            name="media_ftp_root"
            :label="trans('FTP Root')"
            :value="setting('media_ftp_root')"
            placeholder="Ex: /abogo_travel"
        />

        <x-core::form.text-input
            name="media_ftp_custom_domain"
            :label="trans('Custome Domain')"
            :value="setting('media_ftp_custom_domain')"
            :placeholder="trans('Ex: https://your_domain')"
        />
