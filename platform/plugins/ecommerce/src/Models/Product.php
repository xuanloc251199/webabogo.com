...
class Product extends BaseModel
{
    ...
    {
        return $this->belongsToMany(Services::class, "product_service", "product_id", "service_id");
    }
    ...
    public function productsGroupedParent(): BelongsToMany
    {
        return $this->belongsToMany(Product::class, 'ec_grouped_products', 'product_id', 'parent_product_id')
            ->where("type", "hotel")
    ...
    {
        return $this->belongsToMany(Post::class, 'ec_product_blogs', 'product_id', 'blog_id');
    }

    public function places(): \Illuminate\Database\Eloquent\Relations\MorphToMany
    {
